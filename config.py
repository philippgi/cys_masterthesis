...
# =============================
PILOT_SALT_SUBJECT_MAX_INSERTIONS = 10     # Max 1 token per subject
PILOT_SALT_BODY_MAX_INSERTIONS = 40       # Max 3 token per body

PILOT_SALT_MODE = "single"              # "single" or "fragment"
